...
import {
  ...
  SimpleLoginManager, PWO_LOGIN_TABS, HOUSEKEEPING_LOGIN_TABS, HousekeepingWardManager,
} from "./ManagerApp.jsx";
import {
...
export default function COOApp({ user, meta, onLogout }) {
  ...
  const menu = [
    ...
    },
    {
      section: "Setup", items: [
        ...
        { key: "hkwards", icon: icons.grid, label: "Housekeeping Wards" },
  ...
  return (
    ...
    >
      ...
      {tab === "hkwards" && <HousekeepingWardManager showToast={showToast} />}
      {tab === "hkusers" && (
        <SimpleLoginManager
          showToast={showToast}
          tabs={HOUSEKEEPING_LOGIN_TABS}
          title="Housekeeping Users"
          blurb="Manage housekeeping staff and manager logins. Give them wards on the Housekeeping Wards screen under Setup."
        />
      )}
      {tab === "welfare" && (
        <SimpleLoginManager
